        ...
        <div className={cn("flex", layout === "vertical" ? "flex-col gap-1" : "flex-row items-center gap-2")}>
          ...
          <div className={cn(InputVariants({ size }), "z-0 px-3", props.readOnly && "px-[2px]", className)}>
            ...
            <div
              className={cn(
                InputVariants({ size }),
                "absolute inset-0 -z-10 rounded-[6px] border border-primary-500 bg-white",
                "group-hover:border-primary-600 ", // Default
                ...
                "group-hover:peer-data-[error=false]:border-primary-600", // No Error
